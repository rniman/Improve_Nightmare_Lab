...
정상화 후 원형 밴딩이 관찰되었다. `rand`를 고정하면 밴딩이 사라지고, time offset을
제거해도 밴딩은 유지됐다. 현재 8x8 noise 테이블의 반복 방향 패턴이 원인으로 추정되며,
더 큰 blue-noise texture 등 SSAO 품질 개선은 별도 작업으로 남긴다.
