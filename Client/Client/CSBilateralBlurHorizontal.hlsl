...
[numthreads(32, 32, 1)]
void CSBilateralBlurHorizontal(uint3 n3DispatchThreadID : SV_DispatchThreadID)
{
    ...
    {
        int2 sampleCoord = intCoord + int2(x, 0);
        ...
        float spatialWeight = gGaussianWeights[abs(x)];
